...
public final class UpdateChecker {
    ...
    private static final String USER_AGENT = "METABAGOFGOLD-update-checker";
    private static final String UPDATE_URL = "https://api.spigotmc.org/simple/0.1/index.php?action=getResource&id=117870"; // TODO: REPLACE ID WITH BAGOFGOLD ID, UPDATE LANGUAGE FILES WITH CORRECT SPIGOTMC URL
